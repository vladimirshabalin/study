...
$(document).ready(function () {
  ...
  $('.grand-total-price').text("$".concat(mycart.amount));
  $('.sub-total-price').text("".concat(mycart.countGoods));
  ...
  $('.cart-add-btn').on('click', function () {
    ...
    $(this).closest(".goods-item").clone().css({
      'position': 'absolute',
      'z-index': '10001',
  ...
  $(".tingle-modal-box").on("click", '.authorization-tab', function () {
    $(this).addClass('authorization-active-tab').siblings().removeClass('authorization-active-tab');
